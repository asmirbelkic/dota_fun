// --- Config --- //
var purecookieTitle = "Dota Tips"; // Title
var purecookieDesc =
	"En utilisant ce site Web, vous acceptez automatiquement que nous utilisions des cookies."; // Description
var purecookieLink =
	'<a href="cookie-policy.html" target="_blank">Pourquoi ?</a>'; // Cookiepolicy link
var purecookieButton = "Accepter & Fermer"; // Button text
// ---        --- //
